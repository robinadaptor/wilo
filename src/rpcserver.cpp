...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* WILO features */
        {"wilo", "masternode", &masternode, true, true, false},
        {"wilo", "masternodelist", &masternodelist, true, true, false},
        {"wilo", "mnbudget", &mnbudget, true, true, false},
        {"wilo", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"wilo", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"wilo", "mnsync", &mnsync, true, true, false},
        {"wilo", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"wilo", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use wilod, or the -server option to wilo-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> wilo-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:23999/\n";
}
