...
In order to support loading of multiple wallets in wilo-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is wilo.cpp.
...
Changes to wilo.cpp
----------------------
wilo.cpp is the entry point into wilo-qt, and as such, will require some minor modifications to provide hooks for
