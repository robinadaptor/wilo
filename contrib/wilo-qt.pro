...
RESOURCES += src/qt/wilo.qrc src/qt/wilo_locale.qrc

TRANSLATIONS += src/qt/locale/wilo_bg.ts \
                src/qt/locale/wilo_de.ts \
                src/qt/locale/wilo_en.ts \
                src/qt/locale/wilo_es.ts \
                src/qt/locale/wilo_fi.ts \
                src/qt/locale/wilo_fr.ts \
                src/qt/locale/wilo_it.ts \
                src/qt/locale/wilo_ja.ts \
                src/qt/locale/wilo_pl.ts \
                src/qt/locale/wilo_pt.ts \
                src/qt/locale/wilo_ru.ts \
                src/qt/locale/wilo_sk.ts \
                src/qt/locale/wilo_sv.ts \
                src/qt/locale/wilo_vi.ts \
                src/qt/locale/wilo_zh_CN.ts \
                src/qt/locale/wilo_zh_TW.ts
